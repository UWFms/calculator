    ...
    public partial class MainWindow : Window
    {
        ...
        private void Button_ClickCCConvert(object sender, RoutedEventArgs e)
        {
            if (Double.TryParse(textLabel.Text, out double numValue))
            {
                ...
                string text = textLabel.Text; double text1 = Convert.ToDouble(text);
                if (text1 < 0)
                {
                    text1 *= -1;
                }
                string zel; double text2; double[] asd = new double[10]; string drob;
                try
                {
                    ...
                    if (text2 != 0)
                    {
                        ...
                        for (int k = 1; k < 10; k++)
                        {
                            ...
                            string bin = Convert.ToString(Math.Truncate(asd[k - 1] * 2));
                            drob += bin;
                        }
                        drob = drob.TrimEnd('0');
                ...
                try
                {
                    ...
                    if (text2 != 0)
                    {
                        ...
                        for (int k = 1; k < 10; k++)
                        {
                            ...
                            string oct = Convert.ToString(Math.Truncate(asd[k - 1] * 8));
                            drob += oct;
                        }
                        drob = drob.TrimEnd('0');
